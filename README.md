...
## Portfolio Creation (Left Panel)
![Left Panel](attached_assets/screenshots/dashboard_overview.png)
The left panel serves as the main control hub for creating portfolio and adding investments. It includes:
...
- **Manage Portfolios**: Enter a modal to create different portfolios for the analysis. 
- **Import from ETRADE**: Validate ETRADE's API token and secrets to import my current accounts and holdings. 
...
![Projections Chart](attached_assets/screenshots/projections.png)

*The interactive chart shows the growth trajectory of your current holdings vs. a recommended model portfolio.*

![Projections Table](attached_assets/screenshots/projections2.png)
